...
// proxyURL: "http://localhost/BlendBroker/assets/"

        var callBack = function(){
          kendo.alert("PDF successfully created!");
        }

    var name=$.trim(a+'Buyer'+output+s+'.pdf');
...
window.setTimeout(function(){
     ...
     $.ajax({
      type: "POST",
      url:base_url+'Customer/EmailStatement',
      data: { userid: name} ,
...
//demo generatr pdf file


var generatnewpdf= function(a) {
   


        $("#formConfirmation").kendoUpload({
            async: {
                saveUrl: "http://localhost/BlendBroker/"
...
var generatePDFBuyer = function(a) {
...
var s=Math.floor(Math.random() * 10000000000);
    ...
    kendo.drawing.drawDOM("#formConfirmationBuyer", {
      paperSize: "A4",
      margin: {
        left   : "0mm",
        top    : "0mm",
